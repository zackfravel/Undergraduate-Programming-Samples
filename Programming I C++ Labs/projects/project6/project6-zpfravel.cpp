...
int main()
{
	...
	while(!(menuChoice == 'Q')&&!(menuChoice == 'q'))
	{
		...
		{
			//Stores the requirements file information in a string and outputs the string
			ifstream infile;
			infile.open("BSCErequirements.txt");

			//Outputs the BSCERequirements.txt to screen
			while(infile >> requirements)
				cout << requirements << endl;

			//Close BSCERequirements.txt
			infile.close();
			cout << "\n" << endl;
		}
		//Re-display Menu
